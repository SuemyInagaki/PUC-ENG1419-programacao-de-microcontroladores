...
def main():
    ...
    def inicia_timer4():
        global timer4
        if timer4 == None:
            timer4 = Timer(3.0, fim_timer4)
            
            # Não esquece de chamar a start!
            timer4.start()
            toca_campainha()
            
            print("Sensor de distância: aproximou")
    
    def fim_timer4():
        global timer4
        timer4.cancel()
        timer4 = None
        print("Timer 4 acabou")
    ...
    def cancela_timer4():
        ...
        if timer4 != None:
            ...
            print("Sensor de distancia: afastou")
    
    # CRIE UMA FUNÇÃO QUE TOQUE A CAMPAINHA 2 VEZES.
    # AO DETECTAR PROXIMIDADE NO SENSOR DE DISTÂNCIA, CRIE E INICIE UM TIMER
    # DE 3 SEGUNDOS PARA CHAMAR ESSA FUNÇÃO. 
    ...
    sensor_de_distancia.when_in_range = inicia_timer4
    sensor_de_distancia.when_out_of_range = cancela_timer4
    
    def toca_campainha():
        buzzer.beep(n=2,on_time=1.0,off_time=1.0)
    ...
    # Sugestão 1: crie um timer recorrente de 6 segundos que salve o datetime atual e o valor do sensor de
    # luz numa coleção do MongoDB.
    # Sugestão 2: envie uma mensagem de texto para o Telegram se o sensor detectar movimento,
    # mas sem mandar novamente até passar pelo menos 30 segundos.
