...
void setup() {
  ...
  ITimer1.init();
  ITimer1.attachInterruptInterval(1000, repetirMensagem);
...
// VÁ NO SIMULIDE, ABRA O ARQUIVO playground06c.simu E RECARREGUE O FIRMWARE.
...
// COMPILE, RECARREGUE O FIRMWARE, RODE A SIMULAÇÃO E VEJA O LED PISCANDO.
