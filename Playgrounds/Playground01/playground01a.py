...
def main():
    ...
    def apaga_ultimos_leds():
        led4.off()
        led5.off()

    # EM SEGUIDA, FAÇA O CLIQUE NO BOTÃO 2 CHAMAR ESSA FUNÇÃO.
    
    botao2.when_pressed = apaga_ultimos_leds
    ...
    def pisca_ultimos_leds():
        led4.blink(n=2, on_time=1.0, off_time=1.0)
        sleep(1)
        led5.blink(n=2, on_time=1.0, off_time=1.0)

    botao1.when_pressed = pisca_ultimos_leds
