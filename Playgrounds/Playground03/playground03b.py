...
def main():
    ...
    filme1 = {"nome": "Naruto The Movie",               "diretor": "Kishimoto",  "ano": 2010,  "duração": 148,  "tem_no_netflix": True}
    filme2 = {"nome": "Matrix",  "diretor": "Nao Conheco",        "ano": 2000,  "duração": 104,  "tem_no_netflix": False}
 
    album1 = {"nome": "Nao conheco",  "artista": "Sasuke",               "estilo": "Rock",        "ano": 1975,  "tem_no_spotify": True}
  
    
    
    colecao_de_filmes.insert_many([filme1, filme2])
    
    colecao_de_albums.insert_one(album1)
